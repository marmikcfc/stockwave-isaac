...
echo '<table>';
echo "<tr> <th>Trader Name</th>  <th>Cash In Hand</th> <th>Stock Value</th> <th>Total Asset</th></tr>";


while($row3 = mysql_fetch_array( $result3 ))
{
	$brokage=$balanceadd*0.0025;
	$shareprofit=$balanceadd-$brokage;
	$english_format_number1 = number_format($shareprofit, 2, '.', '');
