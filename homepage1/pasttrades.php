...
<ul>
<li> <a href="#"> Home  </a></li> <blockquote> | </blockquote>
...
echo '<table id="buy1">';
echo "<tr> <th>Share Name</th> <th>Total Buy</th>  <th>Buy Cost</th> <th>Total Buy Cost</th><th>Buy Date</th> </tr>";
...
echo '<table id="sell1">';
echo "<tr> <th>Share Name</th> <th>Total Sell</th>  <th>Sell Rate</th> <th>Total Sell Profit</th><th>Sell Date</th> </tr>";
// keeps getting the next row until there are no more to get
while($row = mysql_fetch_array( $result )) {
	// Print out the contents of each row into a table
	echo "<tr><td>"; 
